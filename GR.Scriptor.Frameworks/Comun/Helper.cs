...
namespace GR.Scriptor.Framework
{
    ...
    {
        public static T ConvertirJsonAObjeto<T>(string cadenaJson)
        {
            //Request = JsonConvert.SerializeObject(request, Formatting.None, new IsoDateTimeConverter() { DateTimeFormat = "dd.MM.yyyy" });// HH:mm:ss
            return (T)JsonConvert.DeserializeObject(cadenaJson, typeof(T), new IsoDateTimeConverter() { DateTimeFormat = "dd/MM/yyyy" });
        }
        public static string ConvertObjectToJson(Object _object)
        {
            string cycleJson = JsonConvert.SerializeObject(_object, Newtonsoft.Json.Formatting.None, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
            return cycleJson;
        }
        public static JObject ConvertObjectToJObject(Object _object)
        {
            ...
            //};
            JObject cycleJson = JObject.Parse(JsonConvert.SerializeObject(_object, Newtonsoft.Json.Formatting.None, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }));
            return cycleJson;
        }
        ...
        public static byte[] DescargarInagen(string url)
        {
            byte[] fileBytes;
        ...
        public static DataTable ConvertJsonArrayToDataTable(string json)
        {
            var srcArray = JArray.Parse(json);
        ...
        public static string enviarPostWF(string rutaServicio, string variables)
        {
            //Our postvars
            byte[] buffer = Encoding.UTF8.GetBytes(variables);
            //Initialization, we use localhost, change if applicable
            HttpWebRequest WebReq =
            (HttpWebRequest)WebRequest.Create(rutaServicio);
